...
router.post('', AuthController.verifyJWT, body(['year', 'originalTeam']).notEmpty(), 
    body(['pickingTeamName', 'pickingOwnerName', 'round', 'overall', 'contractYearsOriginal', 'contractYearsRemaining'], 'You must specify pickingTeamName, pickingOwnerName, round, overall, contractYearsOriginal, and contractYearsRemaining for requests that specify a player').if(body('player').notEmpty()).notEmpty(), 
